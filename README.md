...
ระบบนี้มีการใช้ JWT (JSON Web Token) สำหรับ Authentication เพื่อรักษาความปลอดภัยของข้อมูล และควบคุมการเข้าถึง Endpoint ต่างๆ นอกจากนี้ยังสามารถเชื่อมต่อกับ API ของผู้ใช้งานอื่น (External API Integration) เพื่อดึงข้อมูล Task จากระบบภายนอกมารวมแสดงผลได้ใน Endpoint เดียว
